...
namespace TMKStore.Migrations
{
    ...
    [Migration("20250510154125_orderProd")]
    partial class orderProd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TMKStore.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9cfe5167-5456-4079-8172-02755cb7b0dc"),
                            Email = "admin@mail.ru",
                            Name = "Admin",
                            Password = "$2a$11$f9b54I20ZXnWokGHnyycguqz3jAVvY3IdB8M5CRSVGTNuaj0ahRRS",
                            Role = "Admin"
                        });
                });
